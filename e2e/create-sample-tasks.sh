...
curl -X POST \
    ...
    -d "{\"modelId\": \"Model17\", \"hyperparametersId\": \"hpset5\", \"checkpointId\": \"ckpt-7\", \"taskId\": \"task101\", \"deadline\": \"2019-12-31T23:59:59Z\", \"active\": false, \"taskSpec\": \"http://goo.gl/T1.zip\"}" \
...
curl -X POST \
    -H "Content-Type: application/json" \
    -d "{\"modelId\": \"Model3\", \"hyperparametersId\": \"hpset3\", \"checkpointId\": \"ckpt-3\", \"taskId\": \"task102\", \"deadline\": \"2019-11-31T23:59:59Z\", \"active\": true, \"taskSpec\": \"http://goo.gl/T2.zip\"}" \
    $FLEA_URL/create_task
...
curl -X POST \
    -H "Content-Type: application/json" \
    -d "{\"modelId\": \"Model5\", \"hyperparametersId\": \"hpset13\", \"checkpointId\": \"ckpt-2\", \"taskId\": \"aaa\", \"deadline\": \"2019-12-14T23:59:59Z\", \"active\": true, \"taskSpec\": \"http://goo.gl/T3.zip\"}" \
    $FLEA_URL/create_task
...
curl -X POST \
    -H "Content-Type: application/json" \
    -d "{\"modelId\": \"Model5\", \"hyperparametersId\": \"hpset3\", \"checkpointId\": \"ckpt-5\", \"taskId\": \"x3\", \"deadline\": \"2023-12-31T23:59:00Z\", \"active\": true, \"taskSpec\": \"http://goo.gl/Tx3.zip\"}" \
    $FLEA_URL/create_task
...
curl -X POST \
    -H "Content-Type: application/json" \
    -d "{\"modelId\": \"Model15\", \"hyperparametersId\": \"hpset1\", \"checkpointId\": \"ckpt-42\", \"taskId\": \"y5\", \"deadline\": \"2019-12-21T23:59:59Z\", \"active\": true, \"taskSpec\": \"http://goo.gl/Tx5.zip\"}" \
    $FLEA_URL/create_task
...
curl -X POST \
    -H "Content-Type: application/json" \
    -d "{\"modelId\": \"Model-bozo5\", \"hyperparametersId\": \"hpset1\", \"checkpointId\": \"ckpt-52\", \"taskId\": \"b7\", \"deadline\": \"2029-12-31T23:59:59Z\", \"active\": true, \"taskSpec\": \"http://goo.gl/Tzxe3.zip\"}" \
    $FLEA_URL/create_task
